...
<body ng-app="myApp" ng-controller="userCtrl" ng-init='bodyInit()'>
    ...
    <div class="container">
      ...
      <h2>전체 리스트</h2>
        ...
        <th>
          <button class="w3-btn w3-ripple" ng-click="editContents(contents.fnk_uid)">&#9998; 편집</button>
        </th>
        <th>
          <button class="w3-btn w3-ripple" ng-click="delete(contents.fnk_uid)">&#9998; 삭제</button>
        </th>
    ...
    <div class="w3-container">
      <button class="btn btn-info btn-lg"  ng-click="newcontents()" >&#10004;  새 링크입력</button>
      <br>
    ...
    <form ng-show="shwoContents" class="w3-container" id="div_input" name="div_input">
      ...
      <br>
        <label>링크</label>
        <TEXTAREA class="w3-input w3-border" id=inputSolution ng-model="link" ng-disabled="!check_save" NAME='cmd' ROWS=2 COLS=100 placeholder="이슈" class="form-control" tabindex='2'></TEXTAREA>
        <br>
